...
The active effort is the **P0 카탈로그 확장 구현 맵** ([#78](https://github.com/flameware/massive-design/issues/78)). Before changing components, Storybook, or Figma assets for this effort, read the map and claim an unblocked child ticket using `docs/agents/issue-tracker.md`.
