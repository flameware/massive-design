...
const componentContract = {
  ...
  reference: { example: "field", guidance: { use: "라벨, 컨트롤, 도움말과 오류를 접근 가능한 한 필드로 조립한다.", evidence: "투자 입력 화면의 라벨·메모·검증 메시지를 일관된 구조로 묶어야 한다.", limits: "폼 상태 관리, 검증 규칙, 제출 동작은 소비처가 소유한다." } },
} as const
