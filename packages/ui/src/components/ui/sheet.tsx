...
const HEADER = "flex flex-col gap-2 text-left"
const FOOTER = "mt-auto flex flex-col-reverse gap-2 sm:flex-row sm:justify-end"
...
function SheetOverlay({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Overlay>) { return <SheetPrimitive.Overlay data-slot="sheet-overlay" className={cn(OVERLAY, className)} {...props} /> }
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) { return <div data-slot="sheet-header" className={cn(HEADER, className)} {...props} /> }
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) { return <div data-slot="sheet-footer" className={cn(FOOTER, className)} {...props} /> }
function SheetTitle({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Title>) { return <SheetPrimitive.Title data-slot="sheet-title" className={cn(TITLE, className)} {...props} /> }
function SheetDescription({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Description>) { return <SheetPrimitive.Description data-slot="sheet-description" className={cn(DESCRIPTION, className)} {...props} /> }
...
const componentContract = {
  ...
  parts: {
    SheetOverlay: staticPart(OVERLAY),
    SheetHeader: staticPart(HEADER),
    SheetFooter: staticPart(FOOTER),
    SheetTitle: staticPart(TITLE),
    SheetDescription: staticPart(DESCRIPTION),
  },
  behaviors: {},
